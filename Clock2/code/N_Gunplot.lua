function N_Gunplot()
    ...
    SetLoop2Plot(L2Arr1,P6, "duskHat1", 131, {1,2,1,2,1,2,3,2,3}, {54,53,55,56,44,45,46,47,48}, duskhat2TL)
    ...
    SetLoop2Plot(L2Arr1,P6, "duskHat3", 131, {5,1,5,2,5,1,5,2,5}, {54,55,53,56,48,55,54,56,54}, duskhat2TL)
    ...
    L1timer = CreateCcode()
    SetLoop2Plot(L2Arr1, P6, "duskLair1", 132, {6,6,6,6,6,6,6,6}, {54,53,65,66,54,77,78}, duskLair1TL)
    SetLoop2Plot(L2Arr1, P6, "duskLair1", 132, {6,6,6,6,6,6,6,6}, {55,56,55,56,55,56,55}, duskLair1TL)
    ...
    -- SetLoop2Plot(L2Arr2, P6, "duskLair3", 132, {7,8,7,8,9,8,9,7,7,8,7,9,8,10}, {37,44,38,58,80,78,56,48,65,68,66,58,56,53}, duskLair3TL)
    SetLoop2Plot(L2Arr2, P6, "duskLair3", 132, {1,2,1,2,3,2,3,1,1,2,1,3,2,4}, {37,44,38,58,80,78,56,48,65,68,66,58,56,53}, duskLair3TL)
    SetEffectplot1(P6, "duskLair3", 132, 84, {8,9,8,9,9,9,9,8,8,9,8,9,9,8}, duskLair3TLEft)
    
    -- SetLoop2Plot(L2Arr3, P6, "duskHive1", 133, {12,14,11,13,12,14,11,13}, {54,55,77,80,87,56,51,78}, duskHive1TLEft)
    -- SetLoop2Plot(L2Arr3, P6, "duskHive1", 133, {12,12,12,12,12,12,12,12}, {84,84,84,84,84,84,84,84}, duskHive1TLEft)

    SetLoop2Plot(L2Arr3, P6, "duskHive1", 133, {2,4,1,3,2,4,1,3}, {54,55,77,80,87,56,51,78}, duskHive1TLEft)
    SetLoop2Plot(L2Arr3, P6, "duskHive1", 133, {2,2,2,2,2,2,2,2}, {84,84,84,84,84,84,84,84}, duskHive1TLEft)
