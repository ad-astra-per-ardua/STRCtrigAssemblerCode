function FinalBossTrigger()
    ...
    Deaths(P7, AtLeast, 1, 168)},{
        RotatePlayer({
        DisplayTextX(StrDesignX("\x04마린키우기 \x19U\x17niverse \x07[1.1v] Normal\x04을 클리어 하셨습니다 ! .").."\n"..StrDesignX("\x04플레이 해주셔서 정말 \x19감사드립니다!").."\n"..StrDesignX("\x08To be Continued."),4),
    ...
    Trigger2X(FP,{
        ...
        Deaths(P7, AtLeast, 1, 168)},{
            RotatePlayer({
            DisplayTextX(StrDesignX("\x04마린키우기 \x19U\x17niverse \x07[1.1v] \x08Hard\x04를 클리어 하셨습니다 ! .").."\n"..StrDesignX("\x04플레이 해주셔서 정말 \x19감사드립니다!").."\n"..StrDesignX("\x08To be Continued."),4),
            PlayWAVX("staredit\\wav\\epilogue.ogg"),
            PlayWAVX("staredit\\wav\\epilogue.ogg"),
            SetMemoryBA(0x657A9C, SetTo, 1),
            },{Force1, Force5},FP);
