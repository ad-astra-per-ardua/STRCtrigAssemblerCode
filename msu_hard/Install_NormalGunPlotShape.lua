...
----------------------------------------------- Start of hard level plot -------------------------------------------------------------------------------
        ...
        function HatcheryGunplot2( Hatname, Deathvar)
            ...
            function HiveGunPlot2lv(Hivename, DeathVar)
                ...
                CSPlotOrder(CS_Rotate(LGU3,10*(e-1)), P7, 95, Hivename, nil, 1, 20, CS_Rotate(LGU3,10*(e-1)), 0, Attack , "HealZone", nil, 0, nil, P7, {Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,DeathVar )})
                CSPlotOrder(CS_Rotate(spiral1,10*(e-1)), P7, 88, Hivename, nil, 1, 20, CS_Rotate(spiral1,10*(e-1)), 0, Attack , "HealZone", nil, 0, nil, P7, {Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,DeathVar )})
                end
                Trigger2(P6, {Deaths(P10, AtLeast, (HiveGenTime2[8] * SDspeed) + 5, DeathVar )})
                CIfEnd()
            end
