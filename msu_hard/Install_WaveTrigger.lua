...
for i = 1 , 5 do
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("celebrate1")})
...
for i = 11, 15 do
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i + 120, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("celebrate1")})
...
for i = 16, 20 do
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i + 180, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("celebrate1")})
...
for i = 1 , 5 do
	...
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("HealZone")})
	...
	CSPlotOrder(CenterCallShape, P6, CenterCallGen1[genIndex], "HealZone", nil, 1, 32, CenterCallShapeA, nil, Attack, "callArrival", nil, 32, nil, P6, {Deaths(P8, Exactly, Gentime * i, 132)})
end
...
for i = 6, 10 do
	...
	CSPlotOrder(CenterCallShape, P6, CenterCallGen2[genIndex], "HealZone", nil, 1, 32, CenterCallShapeA, nil, Attack, "callArrival", nil, 32, nil, P6, {Deaths(P8, Exactly, Gentime * i, 132)})
end
...
for i = 11, 15 do
    ...
    local genIndex = ((i - 1) % arrayLength) + 1
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i + 120, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("HealZone")})
	CSPlotOrder(Bigwave1, P6, 65, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)})
	CSPlotOrder(Bigwave1, P6, 66, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)})
	...
	CSPlotOrder(CenterCallShape, P6, CenterCallGen3[genIndex], "HealZone", nil, 1, 32, CenterCallShapeA, nil, Attack, "callArrival", nil, 32, nil, P6, {Deaths(P8, Exactly, Gentime * i + 120, 132)})
end
...
for i = 16, 20 do
    ...
    local genIndex = ((i - 1) % arrayLength) + 1
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i + 180, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("HealZone")})
	CSPlotOrder(Bigwave1, P6, 77, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)})
	CSPlotOrder(Bigwave1, P6, 78, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)})
	CSPlotOrder(Bigwave1, P6, 104, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)})
	CSPlotOrder(Bigwave1, P6, 88, "celebrate1", nil, 1, 48, CSMakePolygon(6,1,0,50,1), 0, Attack, "HealZone", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)})
	...
	CSPlotOrder(CenterCallShape, P6, CenterCallGen4[genIndex], "HealZone", nil, 1, 32, CenterCallShapeA, nil, Attack, "callArrival", nil, 32, nil, P6, {Deaths(P8, Exactly, Gentime * i + 180, 132)})
end
...
for i = 21, 30 do
    ...
    local genIndex = ((i - 1) % arrayLength) + 1
	Trigger2(Force1, Deaths(P8, Exactly, Gentime * i + 240, 132), {PlayWAV("staredit\\wav\\bigwave.ogg"),PlayWAV("staredit\\wav\\bigwave.ogg"),MinimapPing("celebrate1"),MinimapPing("celebrate1"),MinimapPing("HealZone")})
	...
	CSPlotOrder(CenterCallShape, P6, CenterCallGen5[genIndex], "HealZone", nil, 1, 32, CenterCallShapeA, nil, Attack, "callArrival", nil, 32, nil, P6, {Deaths(P8, Exactly, Gentime * i + 240, 132)})
end
