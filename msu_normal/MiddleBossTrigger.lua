...
MB1TL={24.5,25,25.5,26,26.5,27,28,28.5,29,30,30.5,
    ...
    CSPlotOrder(Shape11_1, P6, 17, M11, {495,351}, 1, 32, CSMakePolygon(6,0,0,92,7), nil, Attack, "nuke3", nil, 32, nil, P7, {Deaths(P11, AtLeast, M11tl[35] * SDspeed, 160)})
    ...
    CIf(Force2, {Deaths(P11, AtMost, (MB1TL[#MB1TL] * SDspeed) + MB1TL, 161)})
